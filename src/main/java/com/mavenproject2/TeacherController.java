...
import com.mavenproject2.util.JsfUtil;
import com.mavenproject2.util.PaginationHelper;
...
public class TeacherController implements Serializable {
    ...
    private TeacherJpaController jpaController = null;
    ...
    private TeacherJpaController getJpaController() {
        if (jpaController == null) {
            jpaController = new TeacherJpaController(utx, emf);
        }
        ...
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public int getItemsCount() {
                    return getJpaController().getTeacherCount();
                }

                @Override
                public DataModel createPageDataModel() {
                    return new ListDataModel(getJpaController().findTeacherEntities(getPageSize(), getPageFirstItem()));
                }
            };
        }
        return pagination;
    ...
    private void updateCurrentItem() {
        int count = getJpaController().getTeacherCount();
        ...
        if (selectedItemIndex >= 0) {
            current = getJpaController().findTeacherEntities(1, selectedItemIndex).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(getJpaController().findTeacherEntities(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(getJpaController().findTeacherEntities(), true);
    }
    ...
    public static class TeacherControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getJpaController().findTeacher(getKey(value));
        }
